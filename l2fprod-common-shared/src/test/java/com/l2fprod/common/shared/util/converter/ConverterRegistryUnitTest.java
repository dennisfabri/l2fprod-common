 ...
 */
package com.l2fprod.common.shared.util.converter;
...
import com.l2fprod.common.shared.util.converter.Converter;
import com.l2fprod.common.shared.util.converter.ConverterRegistry;
...
public class ConverterRegistryUnitTest extends TestCase {
    ...
    public void testAWT() {
        ...
        assertEquals(new Dimension(100, 100), reg.convert(Dimension.class, "100 x100"));
        assertEquals(new Rectangle(5, 7, 100, 50), reg.convert(Rectangle.class, "5 7 100 50.0"));
        assertEquals(new Insets(154, 878, 911, 0), reg.convert(Insets.class, "154 878 911 0"));
    ...
    private void assertConversionError(Converter converter, Class type, Object value) {
        try {
