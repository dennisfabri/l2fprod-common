 ...
 */
package com.l2fprod.common.shared.swing.plaf;
...
import com.l2fprod.common.shared.swing.plaf.aqua.AquaLookAndFeelAddons;
import com.l2fprod.common.shared.swing.plaf.metal.MetalLookAndFeelAddons;
...
/**
 * Provides additional pluggable UI for new components added by the library. By
 * default, the library uses the pluggable UI returned by
 * {@link #getBestMatchAddonClassName()}.
 * <p>
 * The default addon can be configured using the <code>swing.addon</code> system
 * property as follow:
 * <ul>
 ...
 * {@link #setAddon(String)}method. For example, to install the Windows addons,
 * add the following statement
 * <code>LookAndFeelAddons.setAddon("com.l2fprod.common.shared.swing.plaf.windows.WindowsLookAndFeelAddons");</code>.
 * 
...
public class LookAndFeelAddons {
     ...
     * 
     * Note: the values are added only if they do not exist in the existing look and
     * feel defaults. This makes it possible for look and feel implementors to
     * override library defaults.
     * 
     * Note: the array is traversed in reverse order. If a key is found twice in the
     * array, the key/value with the highest position in the array gets precedence
     * over the other key in the array
     * 
     * @param keysAndValues
     */
     ...
     * <code>UIManager.getLookAndFeel()</code>), this method returns the name of the
     * closest <code>LookAndFeelAddons</code> to use.
     * 
    ...
    /**
     * Gets the addon best suited for the operating system where the virtual machine
     * is running.
     * 
     ...
     * classes, colors and fonts to the LookAndFeelAddons. See
     * {@link ComponentAddon}.
     * 
     * @param component
     */
     ...
     * reinitialized (entries previously added by LookAndFeelAddons will be removed)
     * but the addon will not reinitialize because addon initialize itself through
     * the static block in components and the classes do not get reloaded. This
     * means component.updateUI will fail because it will not find its UI.
     * 
    ...
    /**
     * If true, everytime the Swing look and feel is changed, the addon which best
     * matches the current look and feel will be automatically selected.
     * 
     * @param tracking true to automatically update the addon, false to not
     *                 automatically track the addon. Defaults to false.
