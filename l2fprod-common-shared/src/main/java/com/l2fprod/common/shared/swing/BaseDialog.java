...
public class BaseDialog extends JDialog {
    ...
    /**
     * Used to set the mode of the dialog to OK/CANCEL. When in this mode, a Close
     * button is automatically added to the dialog.
     */
     ...
     * invisible by calling <code>getBanner().setVisible(false);</code> if it is not
     * needed.
     * 
     * @see BannerPanel
     */
    ...
    private void buildUI() {
        ...
        ((JComponent) container).registerKeyboardAction(cancelOrCloseAction,
