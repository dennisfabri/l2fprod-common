...
public class ResourceManager {
    ...
    /**
     * Gets the ResourceManager associated with <code>clazz</code>. It looks for a
     * ResourceBundle named against the class name plus the string "RB". For
     * example, for the com.mypackage.Main, the ResourceBundle com.mypackage.MainRB
     * will be looked up.
     * 
     * @param clazz
     ...
     * <code>all(ResourceManager.class)</code>. It returns the ResourceManager named
     * "AllRB" located in the same package ResourceManager class (i.e
     * com.l2fprod.common.shared.util.AllRB).
     * 
    ...
    public static ResourceManager ui() {
        return get("com.l2fprod.common.shared.swing.AllRB");
    }

    /**
     * Resolves any references to a resource bundle contained in
     * <code>rbAndProperty</code>. To reference a resource bundle inside a property
     * use <code>${com.package.FileRB:key}</code>, this will look for
    ...
    /**
     * Gets the String associated with <code>key</code> after having resolved any
     * nested keys ({@link #resolve(String)}).
     * 
    ...
    /**
     * Gets the String associated with <code>key</code> after having resolved any
     * nested keys ({@link #resolve(String)}) and applied a formatter using the
     * given <code>args</code>.
     * 
     * @param key  the key to lookup
     ...
     * 
     * @param key the key to lookup
     * @return the first character of the String associated with <code>key</code>.
     */
