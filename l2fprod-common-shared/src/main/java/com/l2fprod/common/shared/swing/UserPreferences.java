...
import com.l2fprod.common.shared.swing.table.TableHelper;
...
public class UserPreferences {
    ...
    /**
     * Gets the default directory chooser. Its current directory will be tracked and
     * restored on subsequent calls.
     * 
    ...
    public static JFileChooser getDirectoryChooser(String id) {
        ...
        try {
            Class directoryChooserClass = Class.forName("com.l2fprod.common.shared.swing.JDirectoryChooser");
    ...
    public static void track(final JRadioButton button) {
        ...
        ((DefaultButtonModel) button.getModel()).getGroup().setSelected(button.getModel(), selected);// .setSelected(selected);
