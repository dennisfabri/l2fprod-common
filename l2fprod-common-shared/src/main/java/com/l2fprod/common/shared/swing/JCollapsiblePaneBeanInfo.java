...
public class JCollapsiblePaneBeanInfo extends SimpleBeanInfo {
    ...
    protected BeanDescriptor bd = new BeanDescriptor(com.l2fprod.common.shared.swing.JCollapsiblePane.class);
    /** Description of the Field */
    ...
    public BeanInfo[] getAdditionalBeanInfo() {
        ...
        BeanInfo[] biarr = null;
        try {
            for (Class cl = com.l2fprod.common.shared.swing.JCollapsiblePane.class.getSuperclass(); !cl
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            try {
                descriptor = new PropertyDescriptor("animated", com.l2fprod.common.shared.swing.JCollapsiblePane.class);
            ...
            try {
                descriptor = new PropertyDescriptor("collapsed",
                        com.l2fprod.common.shared.swing.JCollapsiblePane.class);
            } catch (IntrospectionException e) {
                descriptor = new PropertyDescriptor("collapsed", com.l2fprod.common.shared.swing.JCollapsiblePane.class,
                        "getCollapsed", null);
            }
