...
import com.l2fprod.common.shared.swing.plaf.motif.MotifLookAndFeelAddons;
...
public abstract class AbstractComponentAddon implements ComponentAddon {
     ...
     * 
     * Based on the addon, it calls {@link #addMacDefaults(LookAndFeelAddons, List)}
     * if isMac() or {@link #addMetalDefaults(LookAndFeelAddons, List)} if isMetal()
     * or {@link #addMotifDefaults(LookAndFeelAddons, List)} if isMotif() or
     * {@link #addWindowsDefaults(LookAndFeelAddons, List)} if isWindows() or
     * {@link #addBasicDefaults(LookAndFeelAddons, List)} if none of the above was
     * called.
     * 
     * @param addon
