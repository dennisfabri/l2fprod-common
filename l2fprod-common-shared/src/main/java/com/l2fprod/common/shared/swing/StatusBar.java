...
public class StatusBar extends JComponent {
     ...
     * </code>
     * 
     * would construct a new status bar with two zones (two JLabels) named A and B,
     * the first zone A will occupy 33 percents of the overall size of the status
     * bar and B the left space.
     * 
