 ...
 */
package com.l2fprod.common.fontchooser;
...
import com.l2fprod.common.fontchooser.plaf.FontChooserUI;
import com.l2fprod.common.fontchooser.plaf.JFontChooserAddon;
import com.l2fprod.common.shared.swing.BaseDialog;
 ...
 * 
 * @javabean.class name="JFontChooser" shortDescription="A component that
 *                 supports selecting a Font."
 *                 stopClass="javax.swing.JComponent"
 * 
 * @javabean.attribute name="isContainer" value="Boolean.FALSE" rtexpr="true"
 * 
 * @javabean.icons mono16="JFontChooser16-mono.gif" color16="JFontChooser16.gif"
 *                 mono32="JFontChooser32-mono.gif" color32="JFontChooser32.gif"
 */
public class JFontChooser extends JComponent {
     ...
     *           the font chooser's LookAndFeel.
     */
    ...
    /**
     * Sets the selected font of this JFontChooser. This will fire a
     * <code>PropertyChangeEvent</code> for the property named
     * {@link #SELECTED_FONT_CHANGED_KEY}.
     * 
     * @param f the font to select
     * @see javax.swing.JComponent#addPropertyChangeListener(java.beans.PropertyChangeListener)
     * 
     * @javabean.property bound="true" preferred="true" shortDescription="The
     *                    current font the chooser is to display"
     */
    ...
    /**
     * Similar to {@link #showFontDialog(Component, String)} except it can be called
     * from a static context. Prefer {@link #showFontDialog(Component, String)} if
     * you want to control the dialog created by the method call or if you want to
     * specify a custom {@link FontChooserModel}.
     * 
     * @param parent      the parent <code>Component</code> for the dialog
     * @param title       the String containing the dialog's title
