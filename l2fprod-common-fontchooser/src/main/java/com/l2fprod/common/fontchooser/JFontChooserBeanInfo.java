...
public class JFontChooserBeanInfo extends SimpleBeanInfo {
    ...
    protected BeanDescriptor bd = new BeanDescriptor(com.l2fprod.common.fontchooser.JFontChooser.class);
    /** Description of the Field */
    ...
    public BeanInfo[] getAdditionalBeanInfo() {
        ...
        BeanInfo[] biarr = null;
        try {
            for (Class cl = com.l2fprod.common.fontchooser.JFontChooser.class.getSuperclass(); !cl
                    .equals(javax.swing.JComponent.class.getSuperclass()); cl = cl.getSuperclass()) {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            try {
                descriptor = new PropertyDescriptor("selectedFont", com.l2fprod.common.fontchooser.JFontChooser.class);
            } catch (IntrospectionException e) {
                descriptor = new PropertyDescriptor("selectedFont", com.l2fprod.common.fontchooser.JFontChooser.class,
                        "getSelectedFont", null);
            }
