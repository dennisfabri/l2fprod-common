 ...
 */
package com.l2fprod.common.fontchooser.plaf.windows;
...
public class WindowsFontChooserUI extends FontChooserUI {
    ...
    private void updateDisplay() {
        ...
        if (selected != null) {
            /**
             * PENDING(fred) implement charset String charset =
             * (String)charSetCombo.getSelectedItem(); String text =
             * chooser.getModel().getPreviewMessage(charset); boolean canDisplay =
             * selected.canDisplayUpTo(text) == -1; if (canDisplay) {
             * previewPanel.setText(text); } else { previewPanel.setText("Charset not
             * supported"); }
             **/
