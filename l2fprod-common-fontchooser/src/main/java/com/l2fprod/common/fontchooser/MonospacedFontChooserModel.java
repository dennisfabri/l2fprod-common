...
/**
 * An extension of the
 * {@link com.l2fprod.common.shared.swing.DefaultFontChooserModel} showing only
 * Monospaced fonts.
 */
public class MonospacedFontChooserModel extends DefaultFontChooserModel {
    ...
    /**
     * @param fontFamily
     * @return true if <code>fontFamily</code> can be considered as Monospaced, i.e
     *         if it contains the strings Fixed, Monospaced, ProFont, Console or
     *         Typewriter
     */
