...
import com.l2fprod.common.sheet.swing.ObjectTableModel;
...
public class PropertySheetTableModel extends AbstractTableModel
     ...
     * (non-Javadoc)
     * 
     * @see com.l2fprod.common.shared.propertysheet.PropertySheet#setProperties(com.
     * l2fprod.common.shared.propertysheet.Property[])
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.l2fprod.common.shared.propertysheet.PropertySheet#getProperties()
     */
     ...
     * 
     * @see
     * com.l2fprod.common.shared.propertysheet.PropertySheet#addProperty(com.l2fprod
     * .common.shared.propertysheet.Property)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.l2fprod.common.shared.propertysheet.PropertySheet#addProperty(int,
     * com.l2fprod.common.shared.propertysheet.Property)
     */
     ...
     * 
     * @see
     * com.l2fprod.common.shared.propertysheet.PropertySheet#removeProperty(com.
     * l2fprod.common.shared.propertysheet.Property)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.l2fprod.common.shared.propertysheet.PropertySheet#getPropertyCount()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.l2fprod.common.shared.propertysheet.PropertySheet#propertyIterator()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.l2fprod.common.shared.swing.ObjectTableModel#getObject(int)
     */
    ...
    /**
     * Set whether this model is currently sorting categories. If this changes the
     * sorting, the model will be rebuilt.
     */
    ...
    /**
     * Set whether this model is currently sorting properties. If this changes the
     * sorting, the model will be rebuilt.
     */
     ...
     * contains a category or the column is {@link #NAME_COLUMN}, an {@link Item}
     * object will be returned. If the row is a property and the column is
     * {@link #VALUE_COLUMN}, the value of the property will be returned.
     * 
     ...
     * @param parent          the {@link Item} parent of these properties, null if
     *                        none
     */
            ...
            if (o1 instanceof Property && o2 instanceof Property) {
                ...
                if (prop1 == null) {
                    ...
                    return STRING_COMPARATOR.compare(
                            prop1.getDisplayName() == null ? null : prop1.getDisplayName().toLowerCase(),
