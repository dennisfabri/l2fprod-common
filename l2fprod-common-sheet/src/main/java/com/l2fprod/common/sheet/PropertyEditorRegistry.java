...
public class PropertyEditorRegistry implements PropertyEditorFactory {
     ...
     * <ul>
     * <li>if propertyDescriptor.getPropertyEditorClass() returns a valid value, it
     * is returned, else,
     ...
     * <li>
     * <li>look for editor for the property type using {@link #getEditor(Class)}.it
     * is returned, else</li>
     ...
     * <code>super.registerDefaults()</code> must be called before plugging custom
     * defaults. </b>
     */
    public void registerDefaults() {
        ...
        try {
            Class fontEditor = Class.forName("com.l2fprod.common.shared.beans.editor.FontPropertyEditor");
        ...
        try {
            ...
            registerEditor(Date.class,
                    Class.forName("com.l2fprod.common.shared.beans.editor.JCalendarDatePropertyEditor"));
        ...
        if (!foundDateEditor) {
            ...
            try {
                ...
                registerEditor(Date.class,
                        Class.forName("com.l2fprod.common.shared.beans.editor.NachoCalendarDatePropertyEditor"));
                foundDateEditor = true;
            } catch (ClassNotFoundException e) {
