...
import com.l2fprod.common.sheet.beans.BeanUtils;
...
public class DefaultProperty extends AbstractProperty {
    ...
    /**
     * Writes the value of the Property to the given object. It uses reflection and
     * looks for a method starting with "set" followed by the capitalized Property
     * name and with one parameter with the same type as the Property.
     */
     ...
     * 
     * @see
     * com.l2fprod.common.shared.propertysheet.Property#setValue(java.lang.Object)
     */
    ...
    public String toString() {
        return "name=" + getName() + ", displayName=" + getDisplayName() + ", type=" + getType() + ", category="
                + getCategory() + ", editable=" + isEditable() + ", value=" + getValue();
    }
