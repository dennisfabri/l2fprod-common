...
import com.l2fprod.common.shared.swing.IconPool;
import com.l2fprod.common.shared.swing.LookAndFeelTweaks;
import com.l2fprod.common.shared.swing.plaf.blue.BlueishButtonUI;
 ...
 * implemented through
 * {@link com.l2fprod.common.shared.propertysheet.PropertySheetTableModel#setCategorySortingComparator(Comparator)}
 * and
 * {@link com.l2fprod.common.shared.propertysheet.PropertySheetTableModel#setPropertySortingComparator(Comparator)}
 */
public class PropertySheetPanel extends JPanel implements PropertySheet, PropertyChangeListener {
     ...
     * must be re-added after this call if the table model is not the same as the
     * previous table.
     * 
     * @param table
     */
    ...
    /**
     * Writes the PropertySheet to the given object. If any, it commits pending edit
     * before proceeding with properties.
     * 
     * @param data
     */
    ...
    private void buildUI() {
        ...
        descriptionScrollPane.setBorder(
                LookAndFeelTweaks.addMargin(BorderFactory.createLineBorder(UIManager.getColor("controlDkShadow"))));
    ...
    class SelectionListener implements ListSelectionListener {
        ...
        public void valueChanged(ListSelectionEvent e) {
            ...
            if (prop != null) {
                descriptionPanel.setText("<html>" + "<b>" + (prop.getDisplayName() == null ? "" : prop.getDisplayName())
                        + "</b><br>" + (prop.getShortDescription() == null ? "" : prop.getShortDescription()));
            } else {
    ...
    class ToggleDescriptionAction extends AbstractAction {
        ...
        public ToggleDescriptionAction() {
            ...
            putValue(Action.SHORT_DESCRIPTION, ResourceManager.get(PropertySheet.class)
                    .getString("PropertySheetPanel.description.shortDescription"));
        }
    ...
    class ToggleSortingAction extends AbstractAction {
        ...
        public ToggleSortingAction() {
            ...
            putValue(Action.SHORT_DESCRIPTION,
                    ResourceManager.get(PropertySheet.class).getString("PropertySheetPanel.sort.shortDescription"));
        }
