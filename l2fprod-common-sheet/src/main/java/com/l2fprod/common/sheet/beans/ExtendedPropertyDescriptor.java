...
public class ExtendedPropertyDescriptor extends PropertyDescriptor {
    ...
    /**
     * You can associate a special tablecellrenderer with a particular Property. If
     * set to null default renderer will be used.
     *
    ...
    public static ExtendedPropertyDescriptor newPropertyDescriptor(String propertyName, Class beanClass)
        ...
        if (readMethod == null) {
            throw new IntrospectionException(
                    "No getter for property " + propertyName + " in class " + beanClass.getName());
        }
