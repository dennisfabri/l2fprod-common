...
/**
 * Date Property Editor based on
 * <a href="http://www.toedter.com/en/jcalendar/index.html">toedter JCalendar
 * </a> component. <br>
 */
public class JCalendarDatePropertyEditor extends AbstractPropertyEditor {
     ...
     * Constructor for JCalendarDatePropertyEditor
     * 
     * @param dateFormatString string used to format the Date object, see:
     ...
     * 
     * @return the date choosed as a <b>java.util.Date </b>b> object or null is the
     *         date is not set
     */
    ...
    public String getAsText() {
        ...
        java.text.SimpleDateFormat formatter = new java.text.SimpleDateFormat(getDateFormatString());
