...
import com.l2fprod.common.sheet.PropertySheetTableModel.Item;
import com.l2fprod.common.sheet.swing.HeaderlessColumnResizer;
...
public class PropertySheetTable extends JTable {
    ...
    /**
     * Gets the CellEditor for the given row and column. It uses the editor registry
     * to find a suitable editor for the property.
     * 
    ...
    /**
     * Overriden to register a listener on the model. This listener ensures editing
     * is cancelled when editing row is being changed.
     * 
     ...
     * property handles. Sets this property to true to add an extra indent level to
     * properties.
     * 
    ...
    /**
     * Starts value cell editing even if value cell does not have the focus but only
     * if row is selected.
     */
    ...
    /**
     * Calculates the required left indent for a given item, given its type and its
     * hierarchy level.
     */
