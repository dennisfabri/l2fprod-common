...
import com.l2fprod.common.shared.swing.renderer.BooleanCellRenderer;
import com.l2fprod.common.shared.swing.renderer.ColorCellRenderer;
import com.l2fprod.common.shared.swing.renderer.DateRenderer;
import com.l2fprod.common.shared.swing.renderer.DefaultCellRenderer;
import com.l2fprod.common.sheet.beans.ExtendedPropertyDescriptor;
...
public class PropertyRendererRegistry implements PropertyRendererFactory {
        ...
        if (property instanceof PropertyDescriptorAdapter) {
            ...
            if (descriptor instanceof ExtendedPropertyDescriptor) {
                if (((ExtendedPropertyDescriptor) descriptor).getPropertyTableRendererClass() != null) {
                    try {
                        return (TableCellRenderer) (((ExtendedPropertyDescriptor) descriptor)
                                .getPropertyTableRendererClass()).newInstance();
                    } catch (Exception ex) {
                        ex.printStackTrace();
                    }
                }
    ...
    /**
     * Adds default renderers. This method is called by the constructor but may be
