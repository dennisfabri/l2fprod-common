...
public class DefaultPropertyTest extends TestCase {
    ...
    /**
     * Test a cloned <code>DefaultProperty</code> has its <code>value</code>
     * property copied.
     */
    public void testCloneCopiesValue() {
        ...
        assertSame("Test value reference is copied", dp1.getValue(), clone.getValue());
    }
    ...
    public void testEquals() {
        ...
        /*
         * clone.setValue("changed value"); assertTrue("Test 10", !dp1.equals(clone));
         * 
         * dp1.setValue("changed value"); assertEquals("Test 11", dp1, clone);
         */
