 ...
 */
package com.l2fprod.common.totd.plaf.basic;
...
import com.l2fprod.common.shared.swing.ButtonAreaLayout;
...
public class BasicTipOfTheDayUI extends TipOfTheDayUI {
    ...
    protected JDialog createDialog(Component parentComponent, final ShowOnStartupChoice choice,
        ...
        if (choice != null) {
            showOnStartupBox = new JCheckBox(UIManager.getString("TipOfTheDay.showOnStartupText"),
