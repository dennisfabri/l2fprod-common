 ...
 */
package com.l2fprod.common.totd;
...
import com.l2fprod.common.totd.TipModel.Tip;
import com.l2fprod.common.totd.plaf.JTipOfTheDayAddon;
import com.l2fprod.common.totd.plaf.TipOfTheDayUI;
import com.l2fprod.common.totd.tips.DefaultTipModel;

/**
 * Provides the "Tip of The Day" pane and dialog.<br>
 * Tips are retrieved from the {@link com.l2fprod.common.shared.swing.TipModel}.
 * In the most common usage, a tip (as returned by
 * {@link com.l2fprod.common.shared.swing.TipModel.Tip#getTip()}) is just a
 * <code>String</code>. However, the return type of this method is actually
 * <code>Object</code>. Its interpretation depends on its type: <dl compact>
 * <dt>Component
...
public class JTipOfTheDay extends JComponent {
     ...
     * @param parentComponent
     * @param showOnStartupPref
     * @param force             if true, the dialog is displayed even if the
     *                          Preferences is set to hide the dialog
     * @exception HeadlessException if GraphicsEnvironment.isHeadless() returns
     *                              true.
     * @throws IllegalArgumentException if showOnStartupPref is null
     * @see java.awt.GraphicsEnvironment#isHeadless
     ...
     * dialog.
     * 
     * Additionally, it saves the state of the "Show tips on startup" checkbox using
     * the given {@link ShowOnStartupChoice} object.
     * 
     * @param parentComponent
     * @param choice
     * @exception HeadlessException if GraphicsEnvironment.isHeadless() returns
     ...
     *                        {@link ShowOnStartupChoice#isShowingOnStartup()} is
     *                        false
     * @exception HeadlessException if GraphicsEnvironment.isHeadless() returns
     *                              true.
     * @see java.awt.GraphicsEnvironment#isHeadless
