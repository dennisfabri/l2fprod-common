...
import com.l2fprod.common.shared.swing.plaf.basic.BasicLookAndFeelAddons;
...
public class TOTDTest extends JPanel {
    ...
    public TOTDTest() {
        ...
        try {
            add(makeAction("Windows Look And Feel", UIManager.getSystemLookAndFeelClassName(),
                    WindowsLookAndFeelAddons.class.getName()));
            add(makeAction("Other Look And Feel", UIManager.getCrossPlatformLookAndFeelClassName(),
                    BasicLookAndFeelAddons.class.getName()));
        } catch (Exception e) {
        }
    }
        ...
        ActionListener action = new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                tips.add(new DefaultTip("tip2",
                        "<html>This is an html <b>TIP</b><br><center>" + "<table border=\"1\">"
                                + "<tr><td>1</td><td>entry 1</td></tr>" + "<tr><td>2</td><td>entry 2</td></tr>"
                ...
                // an Icon
                tips.add(new DefaultTip("tip 4",
                        new ImageIcon(BasicTipOfTheDayUI.class.getResource("TipOfTheDay24.gif"))));
