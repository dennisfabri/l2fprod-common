...
/**
 * A File System view which permits to show the DirectoryChooser even in Java
 * Web Start. It circumvents all security exceptions.
 */
public class FakeFileSystemView extends FileSystemView {
    ...
    public FakeFileSystemView() {
        ...
        files.put("getFiles(My Computer)",
                new File[] { (File) files.get("A"), (File) files.get("C"), (File) files.get("D") });
        ...
        FakeFile[] folders = new FakeFile[] { new FakeFile("Folder 1"), new FakeFile("Folder 2"),
                new FakeFile("Folder 3"), };
    ...
    public File[] getFiles(File dir, boolean useFileHiding) {
        if (dir.getName().startsWith("Folder")) {
            return new FakeFile[] { new FakeFile(dir.getName() + ".1"), new FakeFile(dir.getName() + ".2"),
                    new FakeFile(dir.getName() + ".3"), };
        } else {
