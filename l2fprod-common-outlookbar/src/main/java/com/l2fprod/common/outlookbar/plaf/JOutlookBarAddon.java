 ...
 */
package com.l2fprod.common.outlookbar.plaf;
...
import com.l2fprod.common.outlookbar.JOutlookBar;
import com.l2fprod.common.outlookbar.border.FourLineBorder;
import com.l2fprod.common.outlookbar.plaf.basic.BasicOutlookButtonUI;
import com.l2fprod.common.outlookbar.plaf.windows.WindowsOutlookBarUI;
...
public class JOutlookBarAddon extends AbstractComponentAddon {
    ...
    protected void addBasicDefaults(LookAndFeelAddons addon, List defaults) {
        ...
        defaults.addAll(Arrays.asList(new Object[] { JOutlookBar.UI_CLASS_ID, WindowsOutlookBarUI.class.getName(),
                "OutlookButtonUI", BasicOutlookButtonUI.class.getName(), "OutlookBar.background", barBackground,
                "OutlookBar.border", outlookBarBorder, "OutlookBar.tabButtonBorder", outlookBarButtonBorder,
                "OutlookButton.border", outlookButtonBorder, "OutlookBar.tabAlignment",
