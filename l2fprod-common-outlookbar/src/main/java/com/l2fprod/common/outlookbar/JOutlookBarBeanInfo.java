...
public class JOutlookBarBeanInfo extends SimpleBeanInfo {
    ...
    protected BeanDescriptor bd = new BeanDescriptor(com.l2fprod.common.outlookbar.JOutlookBar.class);
    /** Description of the Field */
    ...
    public BeanInfo[] getAdditionalBeanInfo() {
        ...
        BeanInfo[] biarr = null;
        try {
            for (Class cl = com.l2fprod.common.outlookbar.JOutlookBar.class.getSuperclass(); !cl
                    .equals(javax.swing.JTabbedPane.class.getSuperclass()); cl = cl.getSuperclass()) {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            try {
                descriptor = new PropertyDescriptor("animated", com.l2fprod.common.outlookbar.JOutlookBar.class);
