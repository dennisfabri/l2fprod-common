 ...
 */
package com.l2fprod.common.outlookbar;
...
import com.l2fprod.common.outlookbar.plaf.JOutlookBarAddon;
import com.l2fprod.common.outlookbar.plaf.OutlookBarUI;
import com.l2fprod.common.shared.swing.plaf.LookAndFeelAddons;

/**
 * <code>JOutlookBar</code> brings the famous Outlook component to Swing. The
 * component shows stacks of components where only one stack is visible at a
 * time. <br>
 * 
 * The tab orientation of the {@link javax.swing.JTabbedPane}is mapped to the
 * JOutlookBar orientation as follow:
 * <ul>
 * <li>with JTabbedPane.TOP or JTabbedPane.BOTTOM, JOutlookBar will layout the
 * components horizontally
 * <li>with JTabbedPane.LEFT or JTabbedPane.RIGHT, JOutlookBar will layout the
 * components vertically (default)
 * </ul>
 * 
 * @javabean.class name="JOutlookBar" shortDescription="JOutlookBar brings the
 *                 famous Outlook component to Swing"
 *                 stopClass="javax.swing.JTabbedPane"
 * 
 * @javabean.icons mono16="JOutlookBar16-mono.gif" color16="JOutlookBar16.gif"
 *                 mono32="JOutlookBar32-mono.gif" color32="JOutlookBar32.gif"
 */
public class JOutlookBar extends JTabbedPane {
     ...
     * 
     * @beaninfo bound: true hidden: true description: The UI object that implements
     *           the buttonbar's LookAndFeel.
     */
    ...
    /**
     * @return true if this taskpane is animated during expand/collapse transition.
     */
    ...
    /**
     * Builds a JScrollPane to hold the component. By default tabs are not
     * scrollable. They can be made scrollable by putting them in a JScrollPane and
     * adding the JScrollPane instead of the tab to the JOutlookBar. It is
     * recommended to use this method to create the scrollbar as the UI may choose
     * to return a JScrollPane specially configured for the JOutlookBar component
