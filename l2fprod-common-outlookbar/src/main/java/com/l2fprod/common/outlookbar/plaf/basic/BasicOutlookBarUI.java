 ...
 */
package com.l2fprod.common.outlookbar.plaf.basic;
...
import com.l2fprod.common.shared.swing.PercentLayoutAnimator;
...
public class BasicOutlookBarUI extends BasicTabbedPaneUI implements OutlookBarUI {
        ...
        if (button == null) {
            ...
            button.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (((JOutlookBar) tabPane).isAnimated() && current != target && current != null
                            && target != null) {
                        if (animator != null) {
                            animator.stop();
                        }
                ...
                if (selectedComponent != null) {
                    if (selectedComponent != visibleComponent && visibleComponent != null) {
                        ...
                        if (currentFocusOwner != null
                                && SwingUtilities.isDescendingFrom(currentFocusOwner, visibleComponent)) {
                    ...
                    Component[] components = parent.getComponents();
                    for (int i = 0; i < components.length; i++) {
                        if (!(components[i] instanceof UIResource) && components[i].isVisible()
    ...
    /**
     * Wraps any component in a Scrollable JPanel so it can work correctly within a
     * viewport
     */
