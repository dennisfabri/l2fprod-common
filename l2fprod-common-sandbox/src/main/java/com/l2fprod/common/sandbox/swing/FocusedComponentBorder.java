 ...
 */
package com.l2fprod.common.sandbox.swing;
...
/**
 * Paints an highlight if the component or one of its descendants have the
 * focus.
 * 
...
public class FocusedComponentBorder extends AbstractBorder {
    ...
    private static List componentToRepaint = Collections.synchronizedList(new ArrayList(3));
    static {
    ...
    /**
     * Register the given component to be repainted whenever the focused component
     * changes. This must be called for each component using a
    ...
    private static void repaintComponents() {
        WeakReference[] refs = (WeakReference[]) componentToRepaint.toArray(new WeakReference[0]);
