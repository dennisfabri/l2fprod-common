 ...
 */
package com.l2fprod.common.sandbox.application;
...
import com.l2fprod.common.sandbox.application.core.AppContext;
import com.l2fprod.common.sandbox.application.core.XmlUIBuilder;
...
public class Application extends JFrame {
     ...
     * It will:
     * <ul>
     * <li>load the actions.xml (if found in the application package) to init
     * menubar, toolbar and actions</li>
     * </ul>
     */
                ...
                if (statusbar != null) {
                    ...
                    SelectionListener statusBarUpdater = new SelectionListener() {
                        ...
                        public void selectionChanged(SelectionChangedEvent event) {
                            ...
                            message.setText(selection.isEmpty() ? "No Selection"
                                    : String.valueOf(selection.getSelection().length));
                        }
                    };
