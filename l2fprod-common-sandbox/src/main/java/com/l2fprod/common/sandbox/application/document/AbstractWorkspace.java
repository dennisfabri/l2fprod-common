...
public class AbstractWorkspace implements Workspace {
    ...
    /**
     * Called once the document has been opened in this workspace. Subclasses will
     * react by making the document visible to the user.
     * 
     * @param document
     */
    ...
    /**
     * Called once the document has been closed. Subclasses will react by hiding the
     * document.
     * 
     * @param document
     */
