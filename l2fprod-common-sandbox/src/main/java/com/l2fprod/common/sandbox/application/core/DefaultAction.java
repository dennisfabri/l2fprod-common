...
class DefaultAction extends AbstractAction implements UpdateableAction {
     ...
     * <code>accel</code> is used to build a {@link javax.swing.KeyStroke}. To
     * support different operating system behavior a special modifier named
     * <code>menukey</code> can be used to identify the operating system dependent
     * modifier to use in menus (such as "ctrl" on Windows platforms or "Command"
     * key on Mac OS X).
     * 
     * @param accel
     */
    ...
    protected String paramString() {
        return "id=" + getId() + ",text=" + getText() + ",mnemonic=" + getMnemonic() + ",command=" + getCommand()
                + ",enablesFor=" + enablesFor + ",acccel=" + getAccelerator();
    }
