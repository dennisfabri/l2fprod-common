 ...
 */
package com.l2fprod.common.sandbox.application.selection;
...
public interface SelectionProvider {
    ...
    SelectionProvider NULL_PROVIDER = new SelectionProvider() {
    ...
    class Helper {
        ...
        public static SelectionProvider findSelectionProvider(final Component component) {
            if (component instanceof SelectionProvider) {
                ...
                return (SelectionProvider) ((JComponent) component).getClientProperty("SelectionProvider");
            } else {
                return null;
            }
        }

        public static void setSelectionProvider(JComponent component, SelectionProvider provider) {
