...
public abstract class DefaultSelectionProvider
        implements SelectionProvider, ListSelectionListener, TreeSelectionListener, FocusListener {
    ...
    protected void fireSelectionChanged() {
        SelectionListener[] l = (SelectionListener[]) listeners.getListeners(SelectionListener.class);
