 ...
 */
package com.l2fprod.common.sandbox.swing.list;
...
public interface MutableListModel/* <T> */ extends ListModel {
    ...
    /**
     * Move the objects between <code>oldIndex0</code> and <code>oldIndex1</code> to
     * the new position <code>newIndex0</code>.
     * 
     * @param oldIndex0 oldIndex0 the limits of the interval to move
     * @param oldIndex1 oldIndex1 the limits of the interval to move
     * @param newIndex0 the new position of the element that was at oldIndex0
     */
    ...
    public static class Actions {
        ...
        private static void setupAction(final Action action, final Component target, final Updater updater) {
            if (!(target instanceof JList || target instanceof JTable)) {
                throw new IllegalArgumentException("Only JList or JTable are supported by MutableListModel.Actions");
            }
            ...
            } else if (target instanceof JTable && ((JTable) target).getModel() != null) {
                ((ListModel) ((JTable) target).getModel()).addListDataListener(modelListener);
            }
            updater.update(action, target);
        }

        public static Action createMoveToTopAction(final JList list) {
            final Action moveToTop = new AbstractAction(ResourceManager.ui().getString("list.moveTop")) {

                public void actionPerformed(ActionEvent event) {
                    ((MutableListModel) list.getModel()).moveToTop(list.getSelectedIndex());
            ...
            setupAction(moveToTop, list, new Updater() {
                ...
                public void update(Action action, Component p_Target) {
                    action.setEnabled(
                            ((JList) p_Target).getModel().getSize() > 0 && ((JList) p_Target).getSelectedIndex() > 0);
                }
            });
            moveToTop.putValue(Action.SHORT_DESCRIPTION, ResourceManager.ui().getString("list.moveTop"));
            return moveToTop;
        }

        public static Action createMoveUpAction(final JList list) {
            final Action moveUp = new AbstractAction(ResourceManager.ui().getString("list.moveUp")) {
            ...
            moveUp.putValue(Action.SHORT_DESCRIPTION, ResourceManager.ui().getString("list.moveUp"));
            return moveUp;
        }
        ...
        public static Action createMoveDownAction(final JList list) {
            final Action moveDown = new AbstractAction(ResourceManager.ui().getString("list.moveDown")) {
            ...
            setupAction(moveDown, list, new Updater() {
                ...
                public void update(Action action, Component p_Target) {
                    ...
                    action.setEnabled(((JList) p_Target).getModel().getSize() > 0 && selected != -1
                            && selected < (((JList) p_Target).getModel().getSize() - 1));
                }
            });
            moveDown.putValue(Action.SHORT_DESCRIPTION, ResourceManager.ui().getString("list.moveDown"));
            return moveDown;
        }
        ...
        public static Action createMoveDownAction(final JTable table) {
            ...
            setupAction(moveDown, table, new Updater() {
                ...
                public void update(Action action, Component p_Target) {
                    ...
                    action.setEnabled(((JTable) p_Target).getModel().getRowCount() > 0 && selected != -1
        ...
        public static Action createMoveToBottomAction(final JList list) {
            final Action moveToBottom = new AbstractAction(ResourceManager.ui().getString("list.moveBottom")) {

                public void actionPerformed(ActionEvent event) {
                    ((MutableListModel) list.getModel()).moveToBottom(list.getSelectedIndex());
            ...
            moveToBottom.putValue(Action.SHORT_DESCRIPTION, ResourceManager.ui().getString("list.moveBottom"));
            return moveToBottom;
        }

        public static Action createRemoveAction(final JList list) {
            final Action remove = new AbstractAction(ResourceManager.ui().getString("list.remove")) {

                public void actionPerformed(ActionEvent event) {
                    int selected = list.getSelectedIndex();
                    if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(list,
                            ResourceManager.ui().getString("list.removeWarning"),
                            ResourceManager.ui().getString("list.removeWarningTitle"), JOptionPane.YES_NO_OPTION)) {
            ...
            setupAction(remove, list, new Updater() {
                ...
                public void update(Action action, Component p_Target) {
                    action.setEnabled(
                            ((JList) p_Target).getModel().getSize() > 0 && ((JList) p_Target).getSelectedIndex() != -1);
                }
            });
            remove.putValue(Action.SHORT_DESCRIPTION, ResourceManager.ui().getString("list.remove"));
            return remove;
        }
        ...
        public static Action createRemoveAllAction(final JList list) {
            final Action removeAll = new AbstractAction(ResourceManager.ui().getString("list.removeAll")) {

                public void actionPerformed(ActionEvent event) {
                    if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(list,
                            ResourceManager.ui().getString("list.removeAllWarning"),
                            ResourceManager.ui().getString("list.removeAllWarningTitle"), JOptionPane.YES_NO_OPTION)) {
            ...
            removeAll.putValue(Action.SHORT_DESCRIPTION, ResourceManager.ui().getString("list.removeAll"));
            return removeAll;
        }
        ...
        public static Action createActionListAction(final JList list, String text, final ActionList _action) {
