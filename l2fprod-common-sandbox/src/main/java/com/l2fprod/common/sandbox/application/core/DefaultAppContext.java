 ...
 */
package com.l2fprod.common.sandbox.application.core;
...
import com.l2fprod.common.sandbox.application.selection.EmptySelection;
import com.l2fprod.common.sandbox.application.selection.Selection;
import com.l2fprod.common.sandbox.application.selection.SelectionChangedEvent;
import com.l2fprod.common.sandbox.application.selection.SelectionListener;
import com.l2fprod.common.sandbox.application.selection.SelectionProvider;
...
public class DefaultAppContext
    ...
    public DefaultAppContext() {
        ...
        KeyboardFocusManager.getCurrentKeyboardFocusManager().addPropertyChangeListener("focusOwner", focusUpdater);
    }
    ...
    public Action get(String actionId) {
        for (Iterator iter = actions.iterator(); iter.hasNext();) {
            ...
            if (actionId.equals(a.getValue("id"))) {
                return a;
            }
        }
        return null;
    ...
    private void fireSelectionChanged(SelectionChangedEvent event) {
        SelectionListener[] l = (SelectionListener[]) selectionListeners.getListeners(SelectionListener.class);
