 ...
 */
package com.l2fprod.common.sandbox.swing.table;
...
public abstract class AbstractMutableListTableModel/* <T> */ extends AbstractTableModel
        implements com.l2fprod.common.sandbox.swing.list.MutableListModel/* <T> */ {
     ...
     * 
     * @param oldIndex0 , oldIndex1 the limits of the interval to move
    ...
    private void moveComponent(int p_OldIndex, int p_NewIndex) {
        ...
        if (p_OldIndex < 0 || p_OldIndex > getSize()) {
            return;
        }
    ...
    /**
     * AbstractListModel subclasses must call this method <b>after </b> one or more
     * elements of the list change. The changed elements are specified by a closed
     * interval index0, index1, i.e. the range that includes both index0 and index1.
    ...
    /**
     * AbstractListModel subclasses must call this method <b>after </b> one or more
     * elements are added to the model. The new elements are specified by a closed
     * interval index0, index1, i.e. the range that includes both index0 and index1.
     * Note that index0 need not be less than or equal to index1.
     * 
     * @param source The ListModel that changed, typically "this".
    ...
    /**
     * AbstractListModel subclasses must call this method <b>after </b> one or more
     * elements are removed from the model. The new elements are specified by a
     * closed interval index0, index1, i.e. the range that includes both index0 and
     * index1. Note that index0 need not be less than or equal to index1.
     * 
     * @param source The ListModel that changed, typically "this".
     * @param index0 One end of the new interval.
     * @param index1 The other end of the new interval.
