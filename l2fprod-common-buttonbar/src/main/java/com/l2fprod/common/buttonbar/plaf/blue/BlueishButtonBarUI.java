 ...
 */
package com.l2fprod.common.buttonbar.plaf.blue;
...
import com.l2fprod.common.buttonbar.plaf.basic.BasicButtonBarUI;
...
public class BlueishButtonBarUI extends BasicButtonBarUI {
    ...
    protected void installDefaults() {
        ...
        if (b == null || b instanceof UIResource) {
            bar.setBorder(new BorderUIResource(
                    new CompoundBorder(BorderFactory.createLineBorder(UIManager.getColor("controlDkShadow")),
