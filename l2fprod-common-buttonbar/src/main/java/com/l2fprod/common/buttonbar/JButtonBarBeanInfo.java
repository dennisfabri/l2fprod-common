...
public class JButtonBarBeanInfo extends SimpleBeanInfo {
    ...
    protected BeanDescriptor bd = new BeanDescriptor(com.l2fprod.common.buttonbar.JButtonBar.class);
    /** Description of the Field */
    ...
    public BeanInfo[] getAdditionalBeanInfo() {
        ...
        BeanInfo[] biarr = null;
        try {
            for (Class cl = com.l2fprod.common.buttonbar.JButtonBar.class.getSuperclass(); !cl
