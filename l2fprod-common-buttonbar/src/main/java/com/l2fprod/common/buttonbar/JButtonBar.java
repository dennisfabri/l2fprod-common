 ...
 */
package com.l2fprod.common.buttonbar;
...
import com.l2fprod.common.buttonbar.plaf.ButtonBarButtonUI;
import com.l2fprod.common.buttonbar.plaf.ButtonBarUI;
import com.l2fprod.common.buttonbar.plaf.JButtonBarAddon;
 ...
 * IntelliJ).<br>
 * 
 * @javabean.class name="JButtonBar" shortDescription="JButtonBar helps
 *                 organizing buttons together (as seen in Mozilla Firefox or
 *                 IntelliJ)." stopClass="java.awt.Component"
 * 
...
public class JButtonBar extends JComponent implements SwingConstants {
    ...
    /**
     * Sets the orientation of the bar. The orientation must have either the value
     * <code>HORIZONTAL</code> or <code>VERTICAL</code>. If <code>orientation</code>
    ...
    /**
     * This listener tracks buttons added to a JButtonBar. When a button is added,
     * it updates its UI and ensures further ui changes will be tracked too. When
     * the button is removed, it is no longer tracked.
     */
