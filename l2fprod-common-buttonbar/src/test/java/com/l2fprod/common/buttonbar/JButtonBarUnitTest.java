...
public class JButtonBarUnitTest extends TestCase {
    ...
    /**
     * @todo replace the Class.forName with LookAndFeelAddons.initDefaultAddon()
     *       when added
     * @throws Exception
     */
    public void testUIUpdate() throws Exception {
        ...
        int initialChangeListenerCount = button1.getPropertyChangeListeners("UI").length;
        ...
        assertEquals(initialChangeListenerCount + 1, button1.getPropertyChangeListeners("UI").length);
        ...
        assertEquals(initialChangeListenerCount, button1.getPropertyChangeListeners("UI").length);
