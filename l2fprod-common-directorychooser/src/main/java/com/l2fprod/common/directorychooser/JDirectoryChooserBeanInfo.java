...
public class JDirectoryChooserBeanInfo extends SimpleBeanInfo {
    ...
    protected BeanDescriptor bd = new BeanDescriptor(com.l2fprod.common.directorychooser.JDirectoryChooser.class);
    /** Description of the Field */
    ...
    public BeanInfo[] getAdditionalBeanInfo() {
        ...
        BeanInfo[] biarr = null;
        try {
            for (Class cl = com.l2fprod.common.directorychooser.JDirectoryChooser.class.getSuperclass(); !cl
                    .equals(javax.swing.JFileChooser.class.getSuperclass()); cl = cl.getSuperclass()) {
