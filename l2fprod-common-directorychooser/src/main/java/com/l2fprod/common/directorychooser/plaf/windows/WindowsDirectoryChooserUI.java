 ...
 */
package com.l2fprod.common.directorychooser.plaf.windows;
...
import com.l2fprod.common.directorychooser.plaf.DirectoryChooserUI;
import com.l2fprod.common.directorychooser.tree.LazyMutableTreeNode;
...
public class WindowsDirectoryChooserUI extends BasicFileChooserUI implements DirectoryChooserUI {
    ...
    public void rescanCurrentDirectory(JFileChooser fc) {
        ...
        findFile(chooser.getSelectedFile() == null ? chooser.getCurrentDirectory() : chooser.getSelectedFile(), true,
                true);
    }
    ...
    private void updateView(JFileChooser chooser) {
        ...
        preferredSize = new Dimension(Math.max(preferredSize.width, cancelButton.getPreferredSize().width),
    ...
    private class NewFolderAction extends AbstractAction {
        public void actionPerformed(ActionEvent e) {
            ...
            if (!currentDirectory.canWrite()) {
                JOptionPane.showMessageDialog(fc, UIManager.getString("DirectoryChooser.cantCreateFolderHere"),
                        UIManager.getString("DirectoryChooser.cantCreateFolderHere.title"), JOptionPane.ERROR_MESSAGE);
                return;
            }

            String newFolderName = JOptionPane.showInputDialog(fc,
                    UIManager.getString("DirectoryChooser.enterFolderName"), newFolderText,
            ...
            if (newFolderName != null) {
                ...
                if (newFolder.mkdir()) {
                    ...
                    JOptionPane.showMessageDialog(fc, UIManager.getString("DirectoryChooser.createFolderFailed"),
    ...
    private class FileTreeNode extends LazyMutableTreeNode implements Comparable {
        ...
        public boolean canEnqueue() {
            return !isLoaded() && !chooser.getFileSystemView().isFloppyDrive(getFile())
