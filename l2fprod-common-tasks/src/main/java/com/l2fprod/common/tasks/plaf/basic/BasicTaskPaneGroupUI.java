 ...
 */
package com.l2fprod.common.tasks.plaf.basic;
...
import com.l2fprod.common.tasks.JLinkButton;
import com.l2fprod.common.tasks.JTaskPaneGroup;
import com.l2fprod.common.tasks.icons.EmptyIcon;
...
public class BasicTaskPaneGroupUI extends TaskPaneGroupUI {
    ...
    protected void installDefaults() {
        ...
        LookAndFeel.installColorsAndFont(group, "TaskPaneGroup.background", "TaskPaneGroup.foreground",
                "TaskPaneGroup.font");

        LookAndFeel.installColorsAndFont((JComponent) group.getContentPane(), "TaskPaneGroup.background",
    ...
    class ChangeListener implements PropertyChangeListener {
        public void propertyChange(PropertyChangeEvent evt) {
            ...
            if ((JTaskPaneGroup.EXPANDED_CHANGED_KEY.equals(evt.getPropertyName())
                    ...
                    || (JCollapsiblePane.ANIMATION_STATE_KEY.equals(evt.getPropertyName())
                            && "expanded".equals(evt.getNewValue()))) {
    ...
    protected class PaneBorder implements Border {
        ...
        protected void paintTitle(JTaskPaneGroup group, Graphics g, Color textColor, int x, int y, int width,
                int height) {
            configureLabel(group);
        ...
        protected void paintRectAroundControls(JTaskPaneGroup group, Graphics g, int x, int y, int width, int height,
