...
import com.l2fprod.common.tasks.JTaskPane;
...
public class JTaskPaneAddon extends AbstractComponentAddon {
    ...
    protected void addBasicDefaults(LookAndFeelAddons addon, List defaults) {
        ...
        defaults.addAll(Arrays.asList(new Object[] { JTaskPane.UI_CLASS_ID, getPackagename() + ".basic.BasicTaskPaneUI",
                "TaskPane.useGradient", Boolean.FALSE, "TaskPane.background",
    ...
    protected void addWindowsDefaults(LookAndFeelAddons addon, List defaults) {
        ...
        if (addon instanceof WindowsClassicLookAndFeelAddons) {
            defaults.addAll(
                    Arrays.asList(new Object[] { "TaskPane.background", UIManager.getColor("List.background") }));
            ...
            if (WindowsLookAndFeelAddons.HOMESTEAD_VISUAL_STYLE.equalsIgnoreCase(xpStyle)) {
                ...
                if (OS.isWindowsVista()) {
                    ...
                    backgroundGradientStart = new ColorUIResource(
                            (Color) toolkit.getDesktopProperty("win.frame.activeCaptionColor"));
                    backgroundGradientEnd = new ColorUIResource(
            ...
            defaults.addAll(Arrays.asList(new Object[] { "TaskPane.useGradient", Boolean.TRUE, "TaskPane.background",
                    background, "TaskPane.backgroundGradientStart", backgroundGradientStart,
                    "TaskPane.backgroundGradientEnd", backgroundGradientEnd, }));
        }
    }
