...
public class JTaskPaneGroupBeanInfo extends SimpleBeanInfo {
    ...
    protected BeanDescriptor bd = new BeanDescriptor(com.l2fprod.common.tasks.JTaskPaneGroup.class);
    /** Description of the Field */
    ...
    public BeanInfo[] getAdditionalBeanInfo() {
        ...
        BeanInfo[] biarr = null;
        try {
            for (Class cl = com.l2fprod.common.tasks.JTaskPaneGroup.class.getSuperclass(); !cl
                    .equals(java.awt.Component.class.getSuperclass()); cl = cl.getSuperclass()) {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            try {
                descriptor = new PropertyDescriptor("title", com.l2fprod.common.tasks.JTaskPaneGroup.class);
            } catch (IntrospectionException e) {
                descriptor = new PropertyDescriptor("title", com.l2fprod.common.tasks.JTaskPaneGroup.class, "getTitle",
                        null);
            }
            ...
            try {
                descriptor = new PropertyDescriptor("icon", com.l2fprod.common.tasks.JTaskPaneGroup.class);
            } catch (IntrospectionException e) {
                descriptor = new PropertyDescriptor("icon", com.l2fprod.common.tasks.JTaskPaneGroup.class, "getIcon",
                        null);
            }
            ...
            descriptors.add(descriptor);
            try {
                descriptor = new PropertyDescriptor("special", com.l2fprod.common.tasks.JTaskPaneGroup.class);
            } catch (IntrospectionException e) {
                descriptor = new PropertyDescriptor("special", com.l2fprod.common.tasks.JTaskPaneGroup.class,
                        "getSpecial", null);
            }
            ...
            descriptors.add(descriptor);
            try {
                descriptor = new PropertyDescriptor("scrollOnExpand", com.l2fprod.common.tasks.JTaskPaneGroup.class);
            } catch (IntrospectionException e) {
                descriptor = new PropertyDescriptor("scrollOnExpand", com.l2fprod.common.tasks.JTaskPaneGroup.class,
                        "getScrollOnExpand", null);
            }
            ...
            descriptors.add(descriptor);
            try {
                descriptor = new PropertyDescriptor("expanded", com.l2fprod.common.tasks.JTaskPaneGroup.class);
            } catch (IntrospectionException e) {
                descriptor = new PropertyDescriptor("expanded", com.l2fprod.common.tasks.JTaskPaneGroup.class,
                        "getExpanded", null);
            }
            ...
            descriptors.add(descriptor);
            try {
                descriptor = new PropertyDescriptor("collapsable", com.l2fprod.common.tasks.JTaskPaneGroup.class);
            } catch (IntrospectionException e) {
                descriptor = new PropertyDescriptor("collapsable", com.l2fprod.common.tasks.JTaskPaneGroup.class,
                        "getCollapsable", null);
            }
            ...
            descriptors.add(descriptor);
            try {
                descriptor = new PropertyDescriptor("animated", com.l2fprod.common.tasks.JTaskPaneGroup.class);
            } catch (IntrospectionException e) {
                descriptor = new PropertyDescriptor("animated", com.l2fprod.common.tasks.JTaskPaneGroup.class,
                        "getAnimated", null);
            }
