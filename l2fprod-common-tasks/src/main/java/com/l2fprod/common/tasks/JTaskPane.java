...
import com.l2fprod.common.tasks.plaf.JTaskPaneAddon;
import com.l2fprod.common.tasks.plaf.TaskPaneUI;

/**
 * <code>JTaskPane</code> provides an elegant view to display a list of tasks
 * ordered by groups ({@link JTaskPane}.
 * 
 * <p>
 * Although {@link JTaskPaneGroup} can be added to any other container, the
 * <code>JTaskPane</code> will provide better fidelity when it comes to matching
 * the look and feel of the host operating system than any other panel. As
 * example, when using on a Windows platform, the <code>JTaskPane</code> will be
 * painted with light gradient background. Also <code>JTaskPane</code> takes
 * care of using the right {@link java.awt.LayoutManager} (as required by
 * {@link JCollapsiblePane}) so that {@link JTaskPaneGroup} behaves correctly
 * when collapsing and expanding its content.
 * 
 * <p>
 ...
 * 
 * @javabean.class name="JTaskPane" shortDescription="A component that contains
 *                 JTaskPaneGroups." stopClass="java.awt.Component"
 * 
 * @javabean.icons mono16="JTaskPane16-mono.gif" color16="JTaskPane16.gif"
 *                 mono32="JTaskPane32-mono.gif" color32="JTaskPane32.gif"
 */
