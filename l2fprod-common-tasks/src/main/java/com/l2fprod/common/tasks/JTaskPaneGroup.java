 ...
 */
package com.l2fprod.common.tasks;
...
import com.l2fprod.common.shared.swing.JCollapsiblePane;
import com.l2fprod.common.shared.swing.plaf.LookAndFeelAddons;
import com.l2fprod.common.tasks.plaf.JTaskPaneGroupAddon;
import com.l2fprod.common.tasks.plaf.TaskPaneGroupUI;
 ...
 * 
 * @javabean.class name="JTaskPaneGroup" shortDescription="JTaskPaneGroup is a
 *                 container for tasks and other arbitrary components."
...
public class JTaskPaneGroup extends JPanel implements JCollapsiblePane.JCollapsiblePaneContainer {
     ...
     *           the taskpane group's LookAndFeel.
     */
    ...
    /**
     * Sets the icon to be displayed in the border of this pane. Some pluggable UIs
     * may impose size constraints for the icon. A size of 16x16 pixels is the
     ...
     * 
     * <p>
     * Usually the first JTaskPaneGroup in a JTaskPane is marked as special because
     * it contains the default set of actions which can be executed given the
     * current context.
     * 
     ...
     * 
     * 
     * @param scrollOnExpand true to scroll this group to be visible if this group
     *                       is expanded.
     * 
    ...
    /**
     * Adds an action to this <code>JTaskPaneGroup</code>. Returns a component built
     * from the action. The returned component has been added to the
     * <code>JTaskPaneGroup</code>.
     * 
     * @param action
    ...
    protected String paramString() {
        return super.paramString() + ",title=" + getTitle() + ",icon=" + getIcon() + ",expanded="
                + String.valueOf(isExpanded()) + ",special=" + String.valueOf(isSpecial()) + ",scrollOnExpand="
                + String.valueOf(isScrollOnExpand()) + ",ui=" + getUI();
    }
